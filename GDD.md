...
уровень силы — добавляет множитель N к урону от физической атаки героя в ближнем бою <br/>
уровень ловкости — добавляет множитель N к скорости атаки и уменьшает расход энергии на удары и рывки <br/>
уровень выносливости — добавляет 10 HP к запасу здоровья и увеличивает запас энергии <br/>
уровень интеллекта — влияет на запас маны и урон способностями <br/>
...
<H4>Амулеты</H4>
у персонажа может быть N амулетов. Амулеты могут улучшать характеристики персонажа (то, какая характеристика будет улучшена, зависит от амулета), или же напрямую влиять на его параметры и способности, или добавлять модификаторы атаки на атаку героя.  
